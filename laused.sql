...
--- muuda tabeli piirangut (Petson)
alter table Person add constraint tblPerson_GenderId_FK
foreign key (GenderId) references Gender(Id)

-- insert tabelisse Person
...
-- Kustutame kirje tabelist Person, kus Id on 8
select * from Person
go
...
-- aatame kõik kirjed tabelist Person, kus Age on 100, 50 või 20
select *from Person where Age = 100 or 
Age = 50 or Age = 20
select * from Person where Age in (100, 50, 20)


---- Kommenteeri: Vaatame kõik kirjed tabelist Person, kus Email sisaldab '@'
  -- Kommenteeri: Vaatame kõik kirjed tabelist Person, kus City väli algab tähega 'n'
select * from Person where City like 'n%'
select * from Person where Email like '%@%'

-- Kommenteeri: Vaatame kirjed tabelist Person, kus Email koosneb ühest tähemärgist enne ja pärast '@'
...
-- Kommenteeri: Vaatame 50% ridadest tabelist Person
...
---- andmete sisestamine tabelisse Employees
